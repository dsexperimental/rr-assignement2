...
Rather than truncating any final partial year of data, we could impute values
for events not included for the last year. We did not do this however because
there seems go be adequate statistics without that partial year data.
