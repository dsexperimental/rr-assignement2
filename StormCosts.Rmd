...
- __DOH!__ IMplement a better version of the selectBestKeyword and then document it!
...
## returns the best keyword from the list of keywords in the label
...
- If there are multiple matching keywords, we select the best keyword using the
function _selectBestKeyword()_ from the section 
[Utility Functions](#utilityFunctions). This implementation is described below.
...
# _selectBestKeyword()_ - This takes one of the types essentially at random. FIX!
